...
const zhCN = {
  ...
  init: {
    ...
    nextStepsTitle: '接下來建議這樣開始:',
    nextStepsRestart: '如果 Claude Code 已經開著，先重啟讓新命令生效',
    nextStepsTryCommand: '先在任意專案試跑這條命令:',
    nextStepsMenu: '之後想調整配置，可重新執行 {{cmd}}',
...
const en: typeof zhTW = {
  ...
  init: {
    ...
    nextStepsRestart: 'If Claude Code is already open, restart it so the new commands are loaded',
    nextStepsTryCommand: 'Try this in any project:',
    nextStepsMenu: 'Need to change settings later? Run {{cmd}}',
